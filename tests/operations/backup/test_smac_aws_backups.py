...
from aoc_tests.operations.backup.aws import *
...
@pytest.fixture
def aoc_aws_backup() -> AocAwsBackup:
    """Fixture returning aoc aws backup operations."""
    data_vars: AocAwsBackupAvailableVars = AocAwsBackupDataVars(
        cloud_credentials_path="todo"
    )

    if aoc_version == "2.3":
        data_vars = Aoc23AwsBackupDataVars(cloud_credentials_path="todo")
